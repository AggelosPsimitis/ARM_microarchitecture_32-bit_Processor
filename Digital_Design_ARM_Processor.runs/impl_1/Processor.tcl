...
set rc [catch {
  ...
  add_files -quiet C:/Xilinx/Projects/Digital_Design_ARM_Processor/Digital_Design_ARM_Processor.runs/synth_1/Processor.dcp
  read_xdc C:/Xilinx/Projects/Digital_Design_ARM_Processor/Digital_Design_ARM_Processor.srcs/constrs_1/new/zedboard.xdc
  link_design -top Processor -part xc7z030fbg676-3
